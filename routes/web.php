...
// ================== Search Route at the top and Bottom======================================
Route::get('profilee/{dataType}/{slug}', 'PublicController@showspecificprofile');
Route::get('tutor/{dataType}/{slug}', 'PublicController@showtutor');
// Route::get('resourcess/{dataType}/{slug}', 'PublicController@showSpecificResource');
Route::get('demo/', 'PublicController@demo');
Route::get('jobee/{dataType}/{slug}', 'PublicController@showspecificjob');
...
Route::get('register/{id}/{channel}','PublicController@showRegistrationForm');
...
Route::post('post_resource_feed', 'PublicController@postResourcefeed');

Route::get('search-faculty/{id}', 'PublicController@getfacultyResult');
Route::get('view-allfaculty', 'PublicController@facultyall');
Route::get('search-filters', 'PublicController@searchfilters');
Route::get('search/getuserss', 'PublicController@getuserss');
...
Route::group(
    ...
    function () {
        ...
        Route::get('admin/reviewfeed','ReviewController@feed');
        Route::post('admin/deletefeed', 'ReviewController@deletefeed');
        ...
        Route::get('admin/coupon/edit-coupon/{id}', 'CouponController@edit')->name('editCoupon');
        Route::post('admin/store-coupons', 'CouponController@store');
        Route::post('admin/coupon/delete-coupon', 'CouponController@destroy');
        Route::post('admin/coupon/update-coupon/{id}', 'CouponController@update');
...
Route::group(
    ...
    function () {
        ...
        Route::get('job/view-jobdetails/{job_slug}', 'JobController@viewjobdetails')->name('viewjobdetails');
        ...
        Route::post('job/delete-job', 'JobController@destroy');
         Route::get('checkcoupon', 'StripeController@coupon');
    }
);
Route::group(
    ...
    function () {
        if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'services') {
            Route::get('student/services/{status}', 'studentController@showServices')->name('ServiceListing');
            Route::get('student/service/{id}/{status}', 'studentController@showServiceDetail')->name('ServiceDetail');
        }
        Route::post('services/change-status', 'ServiceController@changeStatus');
        Route::get('student/dashboard/edit-service/{id}', 'ServiceController@edit')->name('edit_service');
        ...
        Route::post('student/dashboard/delete-service', 'ServiceController@destroy');
...
Route::group(
    ...
    function () {
        ...
        Route::post('proposal/hire-student', 'ProposalController@hiredFreelencer');
...
Route::group(
    ...
    function () {
        Route::get('/get-student-skills', 'SkillController@getstudentSkills');
        Route::get('/get-skills', 'SkillController@getSkills');
        Route::get('student/dispute/{slug}', 'UserController@raiseDispute');
        Route::post('student/store-dispute', 'UserController@storeDispute');
        Route::get('student/dashboard/experience-education', 'studentController@experienceEducationSettings')->name('experienceEducation');
        Route::get('student/dashboard/resources', 'studentController@resourcesSettings')->name('resources');
        Route::get('student/dashboard/purchased-resources', 'studentController@purchasedResourcesSettings')->name('purchasedResources');
        Route::get('student/dashboard/tutors', 'studentController@tutorsSettings')->name('tutors');
        Route::get('student/dashboard/book-meeting', 'studentController@bookMeetingsSettings')->name('book-meeting');
        Route::get('student/dashboard/my-rooms', 'studentController@myMeetingRooms')->name('my-rooms');        
        Route::get('student/dashboard/billing', 'studentController@billingSettings')->name('billing');
        Route::get('student/dashboard/invoices', 'studentController@invoiceSettings')->name('invoices');        
        Route::get('student/dashboard/courses', 'studentController@coursesSettings')->name('courses');
       
        Route::get('student/dashboard/friend-requests', 'studentController@friendRequestsSettings')->name('friend-requests');
        Route::get('student/dashboard/friends', 'studentController@friendsSettings')->name('friends');
        Route::post('student/store-profile-settings', 'studentController@storeProfileSettings')->name('studentProfileSetting');
        Route::post('student/store-experience-settings', 'studentController@storeExperienceEducationSettings');
        Route::post('student/store-project-award-settings', 'studentController@storeProjectAwardSettings');
        Route::post('student/store-resources-settings', 'studentController@storeResourcesSettings');
        Route::post('student/book-a-meeting', 'studentController@storeBookingMeeting');
        Route::post('student/send-call-request', 'studentController@storeCallRequest');
        Route::post('student/store-tutor-settings', 'studentController@storeTutorSettings');
        Route::post('student/store-courses', 'studentController@storeCoursesSettings');
        Route::get('student/get-student-skills', 'studentController@getstudentSkills');
        Route::post('student/delete-get-student-skills/{id}', 'studentController@deletestudentSkills');
        
          Route::post('student/delete-get-resource/{id}', 'studentController@deletestudentResource');
        
        Route::get('student/get-student-resources', 'studentController@getstudentResources');
        Route::get('student/get-purchased-resources', 'studentController@getpurchasedResources');
        Route::get('student/get-rooms', 'studentController@getMeetingRooms');
        Route::get('student/get-booked-meetings', 'SkillController@getBookedMeetings');
        Route::get('student/get-received-requests', 'studentController@getReceivedRequests');
        Route::get('student/get-sent-requests', 'studentController@getSentRequests');        
        Route::get('student/get-received-invoices', 'studentController@getReceivedInvoices');
        Route::get('student/get-sent-invoices', 'studentController@getSentInvoices');                
        Route::get('student/get-student-friends', 'studentController@getStudentFriends');
        Route::post('student/delete-from-friends-table', 'studentController@deleteFromFriendsTable');
        Route::post('student/rate-a-resource', 'studentController@rateResource');
        Route::post('student/invoice-for-meeting', 'studentController@invoiceForMeeting');        
        Route::post('student/accept-friend-request', 'studentController@acceptFriendRequest');
        Route::get('student/get-student-experiences', 'studentController@getstudentExperiences');
        Route::get('student/get-student-projects', 'studentController@getstudentProjects');
        Route::get('student/get-student-educations', 'studentController@getstudentEducations');
        
         Route::get('student/get-student-degrees', 'studentController@getstudentDegree');
        Route::get('student/get-student-awards', 'studentController@getstudentAwards');
        Route::get('student/jobs/{status}', 'studentController@showstudentJobs');

        // need to remove this ('bilal')
        Route::get('student/job/{slug}', 'studentController@showOnGoingJobDetail')->name('showOnGoingJobDetail');
        Route::get('student/proposals', 'studentController@showstudentProposals')->name('showstudentProposals');
        Route::get('student/dashboard', 'studentController@studentDashboard')->name('studentDashboard');
        Route::get('student/profile', 'studentController@index')->name('personalDetail');
        Route::post('student/upload-temp-image', 'studentController@uploadTempImage');
        Route::post('student/upload-a-resource', 'studentController@uploadResources');
        Route::post('student/store-bank-details', 'studentController@submitBankDetails');
        Route::get('student/dashboard/post-service', 'ServiceController@create')->name('studentPostService');
        Route::get('student/payout-settings', 'studentController@payoutSettings')->name('studentPayoutsSettings');
        // Route::post('student/submit-bank-details{code?}', 'studentController@submitBankDetails');//->name('submitBankDetails');
        Route::get('student/submit-bank-details', 'studentController@submitBankDetails')->name('submitBankDetails');;
        Route::get('student/payouts', 'studentController@getPayouts')->name('getstudentPayouts');
        Route::post('student/submit-bank-details*', 'studentController@submitBankDetails');

    }
);
// Employer|student Routes
Route::group(
    ['middleware' => ['role:employer|student|admin']],
    function () {
        ...
        Route::get('user/package/checkout/{slug}', 'UserController@checkout');
        ...
        Route::get('student/{type}/invoice', 'UserController@getstudentInvoices')->name('studentInvoice');
...
Route::get('get-faculties', 'CategoryController@getfaculties');
Route::get('get-articles', 'PublicController@getArticles');
Route::get('get-course/{content}', 'PublicController@getcourse');
Route::get('get-degree/{content}', 'PublicController@getdegree');

Route::get('get-location/{content}', 'PublicController@getlocation');

Route::get('get-home-slider/{id}', 'PageController@getSlider');
// Route::get('section/get-iframe/{video}', 'PublicController@getVideo');
Route::get('get-top-students', 'studentController@getTopstudents');
Route::get('get-services', 'ServiceController@getServices');
Route::get('resource/{slug}', 'studentController@showSpecificResource');
...
// add bilal
Route::get('package/getpackagedetail/{id}', 'PackageController@getpackagedetail');
...
Route::post('get-student-experiences', 'PublicController@getstudentExperience');
Route::post('get-student-education', 'PublicController@getstudentEducation');
...
Route::post('addmoney/stripepackages', array('as' => 'addmoney.stripepackages', 'uses' => 'StripeController@stripepackages',));
