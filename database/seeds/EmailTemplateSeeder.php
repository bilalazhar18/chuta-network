        ...
        DB::table('email_templates')->insert(
            [
                ...
                [
                    ...
                    'content' => '<p>Hi <strong>%name%!</strong> Thanks for registering at Chuta Network. You can now login to manage your account using the following credentials:<br /> <strong>Username:</strong> %name%<br /> <strong>Password:</strong> %password%<br /> <strong>Email:</strong> %email%<br /> %signature%</p>',
                ...
                [
                    ...
                    'content' => '<p>Hi <strong>%name%!</strong> Thanks for registering at Chuta Network.<br /> Here is your verification code to complete registration process<br /> <strong>Name :</strong> %name%<br /> <strong>Email :</strong> %email%<br /> <strong>Verification Code:</strong> %verification_code%<br /> %signature%</p>',
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                    'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ],
                [
                ...
                [
                    'admin_email' => 'info@yourdomain.com',
                    'email_type_id' => '11',
                    'title' => 'Admin Email Content - Report student',
                    'subject' => 'A student has been reported!',
                    'content' => '<p>Hello,</p>
                    <p>A student <a href="%link%"><strong>%reported_student%</strong></a> has been reported by<strong> <a href="%report_by_link%">%reported_by% </a></strong>&nbsp;</p>
                    <p>Message is given below.</p>
                    <p>%message%</p>
                    <p>%signature%</p>',
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ...
                [
                    ...
                    'content' => '<p>Hello,</p>
                    <p>The <a href="%student_link%"><strong>%student_name%</strong></a> has completed the following project (<strong><a href="%project_link%">%resource_title%</a></strong>).</p>
                    <p>%signature%</p>',
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                    'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ],
                ...
                [
                    ...
                    <p><strong> <a href="%student_link%">%student_name%</a></strong> has sent a new proposal on the following project <a href="%project_link%"><strong>%resource_title%</strong></a>. Project Information is given below.</p>
                ...
                [
                    ...
                    <p>The <a href="%student_link%"><strong>%student_name%</strong></a> have submitted the proposal message on this job <strong><a href="%project_link%">%resource_title%</a></strong>.</p>
                ...
                [
                    'admin_email' => null,
                    'email_type_id' => '18',
                    'title' => 'student Email Content - New Proposal Submitted',
                    'subject' => 'New Proposal Submitted',
                    'content' => '<p>Hello <strong><a href="%student_link%">%student_name%</a></strong>,</p>
                    <p>You have submitted the proposal against this job <strong><a href="%project_link%">%resource_title%</a></strong>. With the following details.</p>
                ...
                [
                    'admin_email' => null,
                    'email_type_id' => '19',
                    'title' => 'student Email Content - Hire student',
                    'subject' => 'Congratulation You are hired!',
                    'content' => '<p>Hello <strong><a href="%student_link%">%student_name%</a></strong>,</p>
                    <p>The <strong><a href="%employer_link%">%employer_name%</a></strong> hired you for the following job <strong><a href="%project_link%">%resource_title%</a></strong>.</p>
                    <p>%signature%</p>',
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                    'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ],
                [
                    'admin_email' => null,
                    'email_type_id' => '20',
                    'title' => 'student Email Content - Send Request',
                    'subject' => 'Offer Received',
                    'content' => '<p>Hi <strong><a href="%student_link%">%student_name%</a></strong>,</p>
                    ...
                    <p><strong>Project Name :</strong> <strong><a href="%project_link%">%resource_title%</a> </strong></p>
                    <p><strong>Message:</strong></p>
                    <p>%message%</p>
                    <p>%signature%</p>',
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ...
                [
                    'admin_email' => null,
                    'email_type_id' => '21',
                    'title' => 'student Email Content - Cancel Job',
                    'subject' => 'Job Cancelled',
                    'content' => '<p>Hello <strong><a href="%student_link%">%student_name%</a></strong>,</p>
                    <p>Unfortunately <strong><a href="%employer_link%">%employer_name%</a></strong> cancelled the <strong><a href="%project_link%">%resource_title%</a></strong> due to following reasons.</p>
                ...
                [
                    'admin_email' => null,
                    'email_type_id' => '22',
                    'title' => 'student Email Content - Proposal Message',
                    'subject' => 'Proposal Message',
                    'content' => '<p>Hello <strong><a href="%employer_link%">%employer_name%</a></strong>,</p>
                    <p>The <strong><a href="%student_link%">%student_name%</a></strong>&nbsp;has submitted the proposal message on this job <strong><a href="%project_link%">%resource_title%</a></strong>.</p>
                    <p>Login to view your proposal message.</p>
                    <p><strong>Message:</strong></p>
                    <p>%message%</p>
                    <p>%signature%</p>',
                ...
                [
                    'admin_email' => null,
                    'email_type_id' => '23',
                    'title' => 'student Email Content - Package Subscribed',
                    'subject' => 'Package Purchased',
                    'content' => '<p>Hello <strong><a href="%student_link%">%student_name%</a></strong>,</p>
                ...
                [
                    'admin_email' => null,
                    'email_type_id' => '24',
                    'title' => 'student Email Content - Job Completed',
                    'subject' => 'Job Completed',
                    'content' => '<p>Hello <strong><a href="%student_link%">%student_name%</a></strong>,</p>
                    <p>The <strong><a href="%employer_link%">%employer_name%</a></strong>&nbsp;has confirmed that the following project (<a href="%project_link%">"<strong>%resource_title%</strong>"</a>) is completed.</p>
                ...
                [
                    ...
                    'content' => '<p>Hello,</p>
                    <p>A dispute has been raised by student <strong><a href="%student_link%"> %student_name% </a></strong> against <a href="%project_link%">"<strong>%resource_title%</strong>"</a>&nbsp;.</p>
                    <p><strong>Reason:</strong> "%reason%"</p>
                    <p>Message is given below.</p>
                    <p>%message%</p>
                    <p>%signature%</p>',
                ...
                [
                    ...
                    'subject' => 'Job Cancelled',
                    'content' => '  <p>Hello,</p>
                                    <p>An Employer <a href="%employer_link%">%employer_name%</a> has cancelled his ongoing project <a href="%project_link%">%resource_title%</a> assigned to <a href="%student_link%"> %student_name% </a></p>
