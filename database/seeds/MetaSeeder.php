    ...
    public function run()
    {
        DB::table('metas')->insert(
            [
                ...
                [
                    'meta_key' => 'students3',
                    'meta_value' => Helper::getSecondHomestudent(),
                    'metable_type' => 'App\Page',
                    'metable_id' => 6,
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                    'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ...
                [
                    'meta_key' => 'students3',
                    'meta_value' => Helper::getThirdHomestudent(),
                    'metable_type' => 'App\Page',
                    'metable_id' => 7,
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                    'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
