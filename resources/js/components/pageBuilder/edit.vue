              ...
              >
                <a-collapse accordion>
                  <a-collapse-panel
                    ...
                    <student-section
                      :element_id="element.id"
                      @removeElement="removeSection(index, 'students')"
                      :parent_index="index"
                      :students="form.meta.students"
                      v-else-if="element.section =='student_section'"
                    ></student-section>
                    <article-section 
                      :element_id="element.id"
...
import studentSection from "./students";
...
export default {
  ...
  methods: {
    ...
    updateSection: function(evt) {
      if (evt.added) {
        if (evt.added.element.section == "student_section") {
          var student = {
            title: "",
            subtitle: "",
            description: "",
          ...
          this.form.meta.students.push(student);
