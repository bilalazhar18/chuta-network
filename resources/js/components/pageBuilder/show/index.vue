<template>
  <div>
    <div v-for="(element, index) in sections" :key="index" :id="'section'+index">
      ...
      <student  
        :element_id="element.id"
        :students="selectedPage.meta.students" 
        :page_id="pageData.id"
        v-if="element.section =='student_section'">
      </student>
      <articles  
        :element_id="element.id"
...
export default {
  components:{slider, categories, services, welcome, app, workTab, student, workVideo, articles, description},
  props: [
