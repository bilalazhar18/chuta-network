    ...
    <section class="wt-haslayout wt-main-section" v-bind:style="{ background: service.sectionColor}">
        <div class="container">
            <div class="row justify-content-md-center">
                ...
                <div class="wt-students-holder wt-students-home row" v-if="access_type == 'service' || access_type == 'both'">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-4 float-left" v-for="(service_item, index) in serviceList" :key="index">
                        <div :class="'wt-students-info ' +service_item.no_attachments">
                            <div :class="'wt-students ' +service_item.enable_slider" v-if="service_item.attachments && service_item.seller.length > 0">
                            ...
                            <div class="wt-students-details">
                                <figure class="wt-students-img" v-if="service_item.seller_count > 0">
