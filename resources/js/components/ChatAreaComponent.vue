        ...
        <div class="wt-chatarea" v-if="chat_start">
            ...
            <div class="wt-replaybox">
                ...
                <div class="wt-iconbox">
                    <i class="fa fa-phone" aria-hidden="true" style="background-image: linear-gradient(rgb(211, 57, 138) 0%, rgb(122, 82, 209) 100%); color: white" v-on:click="sendCall"></i>
    ...
    export default{
      props: ['receiver_id', 'trans_no_msg', 'no_msg', 'img_desc', 'empty_error', 'chat_host', 'chat_port'],
       ...
       methods: {
            ...
            sendCall(){
                let randomRoomName = Math.floor(Math.random() * 1000000000);
                self=this;
                axios.post(APP_URL + '/student/send-call-request', {
                    user_id: this.receiver,
                    is_call: 0,
                    room_name: randomRoomName,
                    body:`https://chuta.network/video-calling/public/?roomName=${randomRoomName}`,
                    status:0
                    ...
                    if(response.data.message=="error"){
                        ...
                        window.open(`https://chuta.network/video-calling/public/?roomName=${randomRoomName}`);
           ...
           isTyping() {
            ...
            sendMessage(e) {
                ...
                if (this.newmessage) {
                    ...
                    this.messages.push({ message: this.newmessage, image: this.image, is_sender: 'yes', id: now, realTime: realTime});
