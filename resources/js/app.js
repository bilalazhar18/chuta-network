...
Vue.component('user_skills', require('./components/ProfileSkillComponent.vue').default);
 //for learn and understand
Vue.component('user_skills1', require('./components/ProfileSkillComponent1.vue').default);

Vue.component('user_resources', require('./components/profileResourceComponent.vue').default);
Vue.component('user_purchased_resources', require('./components/purchasedResourceComponent.vue').default);
Vue.component('book_meetings', require('./components/bookMeetings.vue').default);
Vue.component('my_meeting_rooms', require('./components/myMeetingRooms.vue').default);
Vue.component('send_invoices', require('./components/SendInvoices.vue').default);
Vue.component('sent_requests', require('./components/SentRequestsComponent.vue').default);
Vue.component('received_requests', require('./components/ReceivedRequestsComponent.vue').default);
Vue.component('sent_invoices', require('./components/SentInvoicesComponent.vue').default);
Vue.component('received_invoices', require('./components/ReceivedInvoicesComponent.vue').default);
Vue.component('my_friends', require('./components/MyFriends.vue').default);
Vue.component('student_experience', require('./components/ProfileExperienceComponent.vue').default);
Vue.component('student_education', require('./components/ProfileEducationComponent.vue').default);
Vue.component('student_project', require('./components/ProfileProjectComponent.vue').default);
Vue.component('student_award', require('./components/ProfileAwardComponent.vue').default);
Vue.component('student_courses_completed', require('./components/coursesCompletedComponent.vue').default);
Vue.component('student_courses_in_progress', require('./components/coursesInProgressComponent.vue').default);
...
// Vue.component('experience', require('./components/studentExperienceComponent.vue').default);
// Vue.component('education', require('./components/studentEducationComponent.vue').default);
// Vue.component('crafted_project', require('./components/studentCraftedProjetcsComponent.vue').default);
...
// Vue.component('student-reviews', require('./components/studentReviewsComponent.vue').default);
...
jQuery(document).ready(function () {
    ...
    // jQuery('.filter-course').on('keyup', function () {
    //     var content = jQuery(this).val();
    //     console.log(content);
    //     jQuery('.wt-checkbox2:contains(' + content + ')').show();
    //     jQuery('.wt-checkbox2:not(:contains(' + content + '))').hide();
    // });
    //  jQuery('.filter-course2').on('keyup', function () {
    //     var content = jQuery(this).val();
    //     console.log(content);
    //     jQuery('.wt-checkbox6:contains(' + content + ')').show();
    //     jQuery('.wt-checkbox6:not(:contains(' + content + '))').hide();
    // });

    //  jQuery('.filter-lang').on('keyup', function () {
    //     var content = jQuery(this).val();
    //     console.log(content);
    //     jQuery('.wt-checkbox3:contains(' + content + ')').show();
    //     jQuery('.wt-checkbox3:not(:contains(' + content + '))').hide();
    // });

     jQuery('.filter-courseres').on('keyup', function () {
        var content = jQuery(this).val();
        let res = [];
        $('.showresource').html('');
      
        axios.get(APP_URL + '/get-course/'+content)
         .then(function (data) {
                        res = data.data.courses;
                        console.log('this is outside', res);
                        data.data.courses.forEach(element=>{
$('.showresource').append('<span class="wt-checkbox2"><input type="checkbox" name="category[]" value="'+element.id+'"><label style="margin-top: -25px;display: block;padding-left: 15px;color: #666;font-weight: 400;margin-bottom: 10px;margin-left: 5px">'+element.title+'</label></span>');
                            console.log('this is inside', element.title);
                        });
                    });
    });


         jQuery('.filter-recordsloc').on('keyup', function () {
        var content = jQuery(this).val();
        let res = [];
        $('.showjobloc').html('');
      
        axios.get(APP_URL + '/get-location/'+content)
         .then(function (data) {
                        res = data.data.courses;
                        console.log('this is outside', res);
                        data.data.courses.forEach(element=>{
$('.showjobloc').append('<span class="wt-checkbox2"><input type="checkbox" name="locations[]" value="'+element.id+'"><label style="margin-top: -25px;display: block;padding-left: 15px;color: #666;font-weight: 400;margin-bottom: 10px;margin-left: 5px">'+element.title+'</label></span>');
                            console.log('this is inside', element.title);
                        });
                    });
    });
        ...
        axios.get(APP_URL + '/get-course/'+content)
         .then(function (data) {
                       ...
                       console.log('end here');
                        ...
                        console.log('this is outside', res);
                        data.data.courses.forEach(element=>{
$('.hells').append('<span class="wt-checkbox2"><input type="checkbox" name="skills[]" value="'+element.id+'"><label style="margin-top: -25px;display: block;padding-left: 15px;color: #666;font-weight: 400;margin-bottom: 10px;margin-left: 5px">'+element.title+'</label></span>');
                            console.log('this is inside', element.title);
                        });
                    });
    });
     ...
     jQuery('.filter-course2').on('keyup', function () {
        ...
        axios.get(APP_URL + '/get-degree/'+content)
         .then(function (data) {
                       console.log('here');
                       console.log(data.data.courses);
                        res = data.data.courses;
                        console.log('this is outside', res);
                        data.data.courses.forEach(element=>{
$('.degreeshow').append('<span class="wt-checkbox2"><input type="checkbox" name="degree[]" value="'+element.id+'"><label style="margin-top: -25px;display: block;padding-left: 15px;color: #666;font-weight: 400;margin-bottom: 10px;margin-left: 5px">'+element.title+ " " +"("+element.slug+")"+'</label></span>');
                            console.log('this is inside', element.title);
                        });
                    });
    });
 ...
 jQuery('.filter-course3').on('keyup', function () {
        var content = jQuery(this).val();
        let res = [];
        $('.facultyshow').html('');
      
        axios.get(APP_URL + '/get-faculty/'+content)
         .then(function (data) {
                       console.log('here');
                       console.log(data.data.courses);
                        res = data.data.courses;
                        console.log('this is outside', res);
                        data.data.courses.forEach(element=>{
$('.facultyshow').append('<span class="wt-checkbox2"><input type="checkbox" name="faculty[]" value="'+element.id+'"><label style="margin-top: -25px;display: block;padding-left: 15px;color: #666;font-weight: 400;margin-bottom: 10px;margin-left: 5px">'+element.title+ " " +"("+element.slug+")"+'</label></span>');
                            console.log('this is inside', element.title);
                        });
                    });
    });
    ...
    const registration = new Vue({
        ...
        data: {
            ...
            form_step1: {
                ...
                is_contact_number_error: false,
                industry_error: '',
                is_industry_error: false,
                business_description_error: '',
                is_business_description__error: false,
                faculty_error: '',
                is_faculty_error: false,
                gender_error: '',
                is_gender_error: false
            },
            form_step2: {
                locations_error: '',
                university_error: '',
                ...
                is_university_error: false,
                is_universities_error: false,
                is_degrees_error: false,
                is_subjects_error: false,
                password_error: '',
        ...
        methods: {
            ...
            checkStep1: function (e) {
                ...
                this.form_step1.company_name_error = '';
                this.form_step1.is_company_name_error = false;
                ...
                this.form_step1.is_email_error = false;
                 this.form_step1.contact_number = '';
                this.form_step1.is_contact_number_error = false;
                var self = this;
                ...
                axios.post(APP_URL + '/register/form-step1-custom-errors', form_data)
                    ...
                    .catch(function (error) {
                        ...
                        if (error.response.data.errors.company_name) {
                            self.form_step1.company_name_error = error.response.data.errors.company_name[0];
                            self.form_step1.is_company_name_error = true;
                        }
                        ...
                        if (error.response.data.errors.email) {
                         ...
                         if (error.response.data.errors.contact_number) {
                            self.form_step1.contact_number_error = error.response.data.errors.contact_number[0];
                            self.form_step1.is_contact_number_error = true;
                        }
            ...
            submitUser: function () {
                ...
                form_data.append('first_name',this.company_name);
                ...
                form_data.append('industry', this.industry);
                form_data.append('business_description', this.business_description);
                form_data.append('faculty', this.faculty);
                form_data.append('role', this.user_role);
                form_data.append('university', this.university);
                form_data.append('gender', this.gender);
                form_data.append('image', this.selectedFile);
                form_data.append('channel', this.channel);
                form_data.append('channelId', this.channelId);

               // this.user_role = role;
                
                var self = this;
                console.log("Hey!",form_data)
...
if (document.getElementById("coupon")) {
    const vmdptList = new Vue({
        ...
        methods: {
            selectAll: function () {
                this.is_show = !this.is_show;
                jQuery("#wt-rev-coupon").change(function () {
                    jQuery("input:checkbox").prop('checked', jQuery(this).prop("checked"));
                });
            },
            selectRecord: function () {
    ...
    const studentProfile = new Vue({
                ...
                options: {
                    ...
                    info: {
                        ...
                        onClosing: function (instance, toast, closedBy) {
                            studentProfile.showCompleted(Vue.prototype.trans('lang.profile_update_success'));
                        }
                    }
                }
            },
        ...
        methods: {
            ...
            submitProfileSettings: function () {
                ...
                axios.post(APP_URL + '/student/profile-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.next();
                        } else if (response.data.type == 'error') {
            ...
            submitstudentProfile: function () {
                var self = this;
                var profile_data = document.getElementById('student_profile');
                let form_data = new FormData(profile_data);
                axios.post(APP_URL + '/student/store-profile-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
            ...
            submitExperienceEduction: function () {
                ...
                axios.post(APP_URL + '/student/store-experience-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
            ...
            submitPaymentSettings: function () {
                ...
                axios.post(APP_URL + '/student/store-payment-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showInfo(response.data.processing);
                            setTimeout(function () {
                                window.location.replace(APP_URL + '/student/dashboard');
                            }, 4000);
                        } else {
                            self.showError(response.data.message);
                        }
            ...
            submitResources: function () {
                var self = this;
                var awards_projects = document.getElementById('resources');
                let form_data = new FormData(awards_projects);
                axios.post(APP_URL + '/student/store-resources-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showInfo(response.data.message);
                        } else if (response.data.type == 'error') {
            ...
            submitAwardsProjects: function () {
                var self = this;
                var awards_projects = document.getElementById('courses');
                let form_data = new FormData(awards_projects);
                axios.post(APP_URL + '/student/store-project-award-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showInfo(response.data.message);
                        } else if (response.data.type == 'error') {
            ...
            submitMeeting: function () {
                var self = this;
                var booking_meeting = document.getElementById('meeting');
                let form_data = new FormData(booking_meeting);
                axios.post(APP_URL + '/student/book-a-meeting', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showInfo(response.data.message);
                        } else if (response.data.type == 'error') {
            ...
            submitTutorSettings: function () {
                var self = this;
                var awards_projects = document.getElementById('is-tutor');
                console.log("1")
                let form_data = new FormData(awards_projects);
                console.log("2");
                axios.post(APP_URL + '/student/store-tutor-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showInfo(response.data.message);
                        } else if (response.data.type == 'error') {
            ...
            sendreview: function (resource) {
                var modal_ref = 'myModalRe-' + resource;
                this.$refs[modal_ref].show();
                // window.slug=resource;
                //     console.log(window);
                //     console.log(resource);
                //     this.$refs.myModalRe[].show();
                
            },

            

            giveRating: function (auth_user) {
                if (auth_user == 1) {
                    this.$refs.myModalRef.show();
                } else {
                    jQuery('.wt-loginarea .wt-loginformhold').slideToggle();
            ...
            acceptOrRejectRequest: function (requestId, action) {
                let x = document.getElementById('accept-reject');
                ...
                if (action === 1) {
                    ...
                    axios.post(APP_URL + '/student/accept-friend-request', {
                        ...
                        console.log("Accept action!", requestId)
                        let y = document.getElementById('offer-accepted-by-student');
                    ...
                    axios.post(APP_URL + '/student/delete-from-friends-table', {
                        ...
                        console.log("Reject action!", requestId)
                        let y = document.getElementById('send-offer-note-after-rejection');
                        y.style.display = 'block';
                    });
                ...
                axios.post(APP_URL + '/store/project-offer', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            ...
                            let w = document.getElementById('sending-request-button');
                            let x = document.getElementById('sending-request-button');
                            let y = document.getElementById('send-offer-note');
                            let z = document.getElementById('offer-sent-note');
                            w.innerHTML = 'Request Sent'
                            w.style.pointerEvents = 'none';
                            x.innerHTML = 'Request Sent'
                ...
                axios.post(APP_URL + '/profile/get-wishlist', {
                    ...
                    .then(function (response) {
                        if (response.data.user_type == 'student') {
                            if (response.data.current_student == 'true') {
                                self.disable_btn = 'wt-btndisbaled';
...
if (document.getElementById("settings")) {
    const VueSettings = new Vue({
        ...
        data: {
            ...
            primary_color: 'linear-gradient(180deg, #d3398a 0%, #7a52d1 100%)',
            ...
            submitJob: function () {
                ...
                axios.post(APP_URL + '/job/post-job', form_data)
                    ...
                    .catch(function (error) {
                        ...
                        if (error.response.data.errors.worktype) {
                            self.showError(error.response.data.errors.worktype[0]);
                        }

                        if (error.response.data.errors.paytype) {
                            self.showError(error.response.data.errors.paytype[0]);
                        }

                        if (error.response.data.errors.payrange) {
                            self.showError(error.response.data.errors.payrange[0]);
                        }

                        if (error.response.data.errors.degreearea) {
                            self.showError(error.response.data.errors.degreearea[0]);
                        }

                        if (error.response.data.errors.faculty) {
                            self.showError(error.response.data.errors.faculty[0]);
                        }

                        if (error.response.data.errors.select_job_cats) {
                            self.showError(error.response.data.errors.select_job_cats[0]);
                        }

                        // if (error.response.data.errors.project_levels) {
                        //     self.showError(error.response.data.errors.project_levels[0]);
                        // }
                        // if (error.response.data.errors.student_type) {
                        //     self.showError(error.response.data.errors.student_type[0]);
                        // }
    ...
    const jobVue = new Vue({
        ...
        methods: {
                ...
                axios.post(APP_URL + '/proposal/submit-proposal', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            ...
                            setTimeout(function () {
                                window.location.replace(APP_URL + '/student/proposals');
                            }, 1050);
                        } else {
                            self.loading = false;
                            self.showError(response.data.message);
            ...
            submitDispute: function (id) {
                ...
                var self = this;
                axios.post(APP_URL + '/student/store-dispute', form_data)
                    .then(function (response) {
        ...
        methods: {
            ...
            selectedRole: function (role) {
                ...
                if (role == 2) {
                    ...
                    this.student_options = false;
                } else if (role == 3) {
                    this.employer_options = false;
                    this.student_options = true;
                }
            },
            ...
            openModal: function(id){
                ...
                //return false;
                axios.get(APP_URL + '/package/getpackagedetail/' +id)
                .then(response => {

                    // console.log(response);
                    // console.log(response.data);
                    // console.log(response.data.type);
                    // console.log(response.data.type[0]['cost']);
                    // console.log(response.data.type[0].cost);
                    // console.log(response.data.type[0].slug);
                    // console.log(response.data.type[0].title);
                  
                    //var cost=response.data.type[0]['cost'];
                    //$('#costprice').val(cost);
                     //document.getElementById('costprice').value=cost;
                    // document.getElementById("blabla").innerHTML = 'hassan2';
                     //document.getElementById('blabla').value = '10';
                    // this.cost = response.data.type[0].cost +' '+ 'US';
                     //this.cost = 'Pay'+' '+response.data.type[0].cost+'$';
                     this.cost = 'Pay'+' '+'AUD'+' '+response.data.type[0].cost;
                     this.costhidden = response.data.type[0].cost;
                     this.slug = response.data.type[0].slug;
                     this.title = response.data.type[0].title;
                    //$('#costprice').val()  

                    this.$refs.myModalRef.show();
                     
                   // this.packageID=response.type->id
                    //this.showModal = true
//                this.message = response.data;
            ...
            submitStripeFrom1: function () {
                this.loading = true;
                let stripe_payment = document.getElementById('stripe-payment-form');
                let data = new FormData(stripe_payment);
                var self = this;
                axios.post(APP_URL + '/addmoney/stripepackages', data)
                    .then(function (response) {
                        console.log(response.data);
                        if (response.data.type == 'success') {
                            self.loading = false;
...
if (document.getElementById("services")) {
    const vservices = new Vue({
        ...
        methods: {
            ...
            givereviews: function (slug) {
                console.log('sjshshhshs');
                console.log(slug);
                console.log('endddddddd');
                var modal_ref = 'myModalRefs-'+ slug;
                this.$refs[modal_ref].show(); 
            },
                        ...
                        if (response.data.type == 'success') {
                            ...
                            document.addEventListener('iziToast-closing', function (data) {
                                if (data.detail.id == 'info_notify') {
                                    self.showCompleted(response.data.message);
                                    window.location.replace(APP_URL + '/student/services/posted');
                                }
                            });
                        } else {
                            self.loading = false;
            ...
            getSettings: function () {
                ...
                var segment_array = segment_str.split('/');
                var id = segment_array[segment_array.length - 1];
                if (segment_str == '/student/dashboard/edit-service/' + id) {
                            ...
                            document.addEventListener('iziToast-closing', function (data) {
                                if (data.detail.id == 'info_notify') {
                                    ...
                                    if (response.data.role == 'student') {
                                        window.location.replace(APP_URL + '/student/dashboard/resources');
                                    } else if (response.data.role == 'admin') {
                                        //window.location.replace(APP_URL+'/admin/jobs');
                                    }
                                }
            ...
            hirestudent: function (id, title, text, mode) {
                this.$swal({
                    title: title,
                    text: text,
                    type: "warning",
