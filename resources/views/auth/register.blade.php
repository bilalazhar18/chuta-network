...
$roles = Spatie\Permission\Models\Role::all()->sortByDesc("name")->toArray();
                ...
                <div class="wt-registerformhold">
                    <div class="wt-registerformmain">
                        <div class="wt-joinforms">
                            <form method="POST" action="{{{ url('register/form-step1-custom-errors') }}}" class="wt-formtheme wt-formregister" @submit.prevent="checkStep1" id="register_form" enctype="multipart/form-data">
                                {!! csrf_field() !!}
                                    ...
                                    <div class="wt-haslayout" v-if="step === 1" v-cloak>
                                     ...
                                     <fieldset class="wt-formregisterstart">
                                        <div class="wt-title wt-formtitle">
                                            <h4 class="form-group form-group-half">{{{ trans('lang.start_as') }}}</h4>
                                        </div>
                                    <div class="col-md-12">
                                        @if(!empty($roles))
                                     ...
                                     @endif
                                        ...
                                        <div class="form-group form-group-half" v-show="user_role === 'student'">
                                            <input type="text" name="first_name" class="form-control" placeholder="First Name *" v-bind:class="{ 'is-invalid': form_step1.is_first_name_error }" v-model="first_name">
                                        ...
                                        <div class="form-group form-group-half" v-show="user_role === 'employer'">
                                            <input type="text" name="company_name" class="form-control" placeholder="Company Name *" v-bind:class="{ 'is-invalid': form_step1.is_company_name_error }" v-model="company_name">
                                            <span class="help-block" v-if="form_step1.company_name_error">
                                                <strong v-cloak>@{{form_step1.company_name_error}}</strong>
                                            </span>
                                        </div>

                                        <div class="form-group form-group-half" v-show="user_role === 'student'">
                                            <input type="text" name="last_name" class="form-control" placeholder="Last Name *" v-bind:class="{ 'is-invalid': form_step1.is_last_name_error }" v-model="last_name">
                                        ...
                                        <div class="form-group">
                                            <input id="user_email" type="email" class="form-control" name="email" placeholder="Email *" value="{{ old('email') }}" v-bind:class="{ 'is-invalid': form_step1.is_email_error }" v-model="user_email">
                                        ...
                                        <div v-show="user_role === 'student'">
                                                   ...
                                                   <!--data binding of channel-->
                                                
                                        
                                                   <input type="hidden" id="channel" value="{{isset($channel) ? $channel :''}}" v-model="channel"
                                                        <?php
                                                            if(isset($channel)) {
                                                                ?>
                                                                    :run="channel = '{{isset($channel) ? $channel :''}}'"        
                                                                <?php
                                                            }
                                                        ?>
                                                         >

                                                        <span class="help-block" v-if="form_step1.channelacc_error">
                                                            <strong v-cloak>@{{form_step1.is_channelacc_error}}</strong>
                                                        </span>


                                                        <input type="hidden" id="channelid"  value="{{isset($id) ? $id: ''}}" v-model="channelId"
                                                        
                                                        <?php
                                                            if(isset($id)) {
                                                                ?>
                                                                    :run="channelId = '{{isset($id) ? $id :''}}'"        
                                                                <?php
                                                            }
                                                        ?>
                                                        >

                                                        <span class="help-block" v-if="form_step1.channelid_error">
                                                            <strong v-cloak>@{{form_step1.is_channelid_error}}</strong>
                                                        </span>
                                              
                                       <!--Ending data binding of channel-->
                                        ...
                                        <div class="form-group form-group-half">
                                            <input type="number" name="contact_number" class="form-control" placeholder="Contact Number *" v-bind:class="{ 'is-invalid': form_step1.is_contact_number_error }" v-model="contact_number" maxLength=11>
                                    ...
                                    <fieldset class="wt-registerformgroup">
                                        ...
                                        <div class="form-group">
                                           <label><strong>Upload Profile Photo</strong></label>
                                            ...
                                            <div class="form-group form-group-half">
                                            <input type="file" accept="image/png,image/jpeg,image/jpg" name="image" @change="onFileChange"/>
                                            </div>
                                    ...
                                    <fieldset class="wt-termsconditions">
                                        <div class="wt-checkboxholder">
                                           <span class="wt-checkbox">
                                                ...
                                                <label for="termsconditions" id="term"></label>
                                                <div class="mt-2n-4 ml-4">
                                                <span>{{{ $term_note }}}</span>
                                                </div>
