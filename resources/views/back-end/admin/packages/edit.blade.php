                            ...
                            'id' => 'packages'] ) !!}
                                <fieldset>
                                    ...
                                    @elseif ($package->role_id == 3)
                                        <div class="form-group">
                                            {!! Form::number('student[no_of_connects]', e($options['no_of_connects']), array('class' => 'form-control', 'placeholder'
                                            => trans('lang.no_of_connects'))) !!}
                                        </div>
                                        <div class="form-group">
                                            {!! Form::number('student[no_of_skills]', e($options['no_of_skills']), array('class' => 'form-control', 'placeholder'
                                            => trans('lang.no_of_skills'))) !!}
                                        </div>
                                        <div class="form-group">
                                            {!! Form::number( 'student[no_of_services]', e($no_of_services), ['class' =>'form-control ', 'placeholder' => trans('lang.student_pkg_opt.no_of_services')] ) !!}
                                        </div>
                                        <div class="form-group">
                                            {!! Form::number( 'student[no_of_featured_services]', e($no_of_featured_services), ['class' =>'form-control ', 'placeholder' => trans('lang.student_pkg_opt.no_of_featured_services')] ) !!}
                                        </div>
                                        <div class="form-group">
                                            <span class="wt-select">
                                        ...
                                        @if ($package->trial != 1)
                                            <div class="form-group">
                                                <span class="wt-select">
                                                    {!! Form::select('student[badge]', $badges, $package->badge_id, array('placeholder' => trans('lang.select_badge'))) !!}
                                                </span>
                                            </div>
                                        @endif
                                        <div class="form-group">
