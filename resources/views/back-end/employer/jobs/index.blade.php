												...
												<div class="wt-userlistingcontent">
													<div class="wt-contenthead">
														...
														@if (!empty($job->price) ||
															...
															<ul class="wt-saveitem-breadcrumb wt-userlisting-breadcrumb">
																...
																<li><a href="javascript:void(0);" class="wt-clicksavefolder"><i class="far fa-folder"></i> {{{ trans('lang.type') }}} {{{ $job->worktype }}}</a></li>
																@endif
													...
													<div class="wt-rightarea">
														<div class="wt-btnarea">
															<a href="{{{ url('job/view-jobdetails/'.$job->id) }}}" class="wt-btn">{{ trans('lang.view_detail') }}</a>
															@if($job->expiry_date>$date)
															<a href="{{{ url('job/edit-job/'.$job->id) }}}" class="wt-btn">{{ trans('lang.edit_job') }}</a>
															@else
															<a href="javascript:void(0)" class="wt-btn">{{ trans('lang.edit_job') }}</a>
															@endif

															@if ($proposals->count() > 0)
																<a href="{{{ url('employer/dashboard/job/'.$job->slug.'/proposals') }}}" class="wt-btn">View Application</a>
															@endif
														</div>
