                                ...
                                <div class="wt-managejobcontent wt-verticalscrollbar mCustomScrollbar _mCS_1">
                                    @foreach ($ongoing_jobs as $job)
                                        @php
                                            ...
                                            $student_name = \App\Helper::getUserName($accepted_proposal->freelancer_id);
                                            ...
                                            <div class="wt-userlistingcontent">
                                                ...
                                                <div class="wt-rightarea">
                                                    ...
                                                    <div class="wt-hireduserstatus">
                                                        <h4>{{ trans('lang.hired') }}</h4><span>{{{ $student_name }}}</span>
                                                        <ul class="wt-hireduserimgs">
                                                            <li><figure><img src="{{{ asset($profile_image) }}}" alt="{{{ trans('lang.student') }}}"></figure></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
