                        ...
                        <div class="wt-dashboardboxcontent">
                            <div class="wt-jobdescription wt-tabsinfo">
                                ...
                                <div class="wt-formtheme wt-userform wt-userformvtwo la-job-details-form">
                                    <fieldset>
                                        ...
                                        <div class="form-group form-group-half wt-formwithlabel">
                                            <span class="wt-select">
                                                {!! Form::select('worktype', $worktype, null, array('class' => '', 'placeholder' => trans('lang.select_worktype'), 'v-model'=>'worktype')) !!}
                                            </span>
                                        </div>

                                        <div class="form-group form-group-half wt-formwithlabel">
                                            <span class="wt-select">
                                                {!! Form::select('paytype', $paytype, null, array('class' => '', 'placeholder' => trans('lang.select_paytype'), 'v-model'=>'paytype')) !!}
                                            </span>
                                        </div>


                                         <div class="form-group form-group-half">
                                            <input type="text" name="payrange" class="form-control" placeholder="{{ trans('lang.payrange') }}" v-model="payrange">
                                        </div>
                                    ...
                                    <div class="form-group wt-formwithlabel">
                                     ...
                                     <div class="form-group">
                                        <textarea placeholder="Business Details" name="business_details" cols="92" rows="10">
                                        </textarea>
                                    </div>

                                        @if(!empty($item->item_name))
                                        <div class="form-group form-group-half">
                                            <input type="text" name="universityapp" class="form-control" placeholder="{{ trans('lang.universityapp') }}" v-model="universityapp">
                                        </div>
                            ...
                            <div class="wt-jobcategories wt-tabsinfo">
                                ...
                                <div class="wt-divtheme wt-userform wt-userformvtwo">
                                    <div class="form-group">
                                        <span class="wt-select">
                                                 {!! Form::select('faculty', $faculty, null, array('class' => '', 'placeholder' => trans('lang.faculty'), 'v-model'=>'faculty')) !!}
                                            </span>
                             ...
                             <div class="wt-languages-holder wt-tabsinfo">
                                ...
                                <div class="wt-divtheme wt-userform wt-userformvtwo">
                                    <div class="form-group">
                                        <span class="wt-select">
                                            {!! Form::select('skills[]', $skills, null, array('class' => 'chosen-select', 'multiple', 'data-placeholder' => trans('lang.select_course'))) !!}
                                        </span>
                                    </div>
                                </div>
                            </div>
