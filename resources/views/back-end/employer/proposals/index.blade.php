                    ...
                    @if (!empty($proposals))
                        ...
                        <div class="wt-dashboardboxcontent wt-rcvproposala">
                                ...
                                <div class="wt-userlistingcontent">
                                    ...
                                    <div class="wt-rightarea">
                                        <div class="wt-hireduserstatus">
                                            <h4>{{{ $proposals->count() }}}</h4><span>Application</span>
                            ...
                            @if (!empty($accepted_proposal))
                                <div class="wt-studentholder wt-rcvproposalholder la-free-proposal">
                                <div class="wt-tabscontenttitle">
                                    <h2>{{ trans('lang.hired_students') }}</h2>
                                </div>
                                            ...
                                            @if(!empty($enable_package) && $enable_package === 'true')     
                                                @if (!empty($badge))
                                                    <span class="wt-featuredtag" style="border-top: 40px solid {{ $badge_color }};">
                                                        <img src="{{{ asset(Helper::getBadgeImage($badge_img)) }}}" alt="{{ trans('lang.hired_students') }}" data-tipso="Plus Member" class="template-content tipso_style">
                                                    </span>
                                                @endif
                                            @endif
                            ...
                            @endif 
                            <div class="wt-studentholder wt-rcvproposalholder">
                                    <div class="wt-tabscontenttitle">
                                                        ...
                                                        <div class="wt-btnarea">
                                                            @if (empty($accepted_proposal))
                                                                @if (!empty($order))
                                                                   ...
                                                                   @endif
                                                                @else
                                                                    <a href="javascript:void(0);"  v-on:click.prevent="hirestudent('{{{$proposal->id}}}', '{{$mode}}')" class="wt-btn">{{ trans('lang.hire_now') }}</a>
                                                                @endif
                                                            @endif
                                                        </div>
                                                       {{--  <div class="wt-hireduserstatus">
