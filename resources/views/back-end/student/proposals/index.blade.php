                            ...
                            @if (!empty($proposals) && $proposals->count() > 0)
                                <div class="wt-managejobcontent">
                                    @foreach ($proposals as $proposal)
                                        @php
                                            $student_proposal = \App\Proposal::find($proposal->id);
                                            ...
                                            $detail_link = $proposal->status == 'hired' ? url('student/job/'.$proposal->job->slug) : 'javascript:void(0);';
                                                ...
                                                <div class="wt-rightarea la-pending-jobs">
                                                    <div class="wt-hireduserstatus">
                                                        ...
                                                        @if ( $proposal->status != 'pending' )
                                                            <a href="{{{ url('student/job/'.$proposal->job->slug) }}}" class="wt-btn">
                                                                {{$status_btn}}
                                                            </a>
                                                        @endif
                                                    </div>
