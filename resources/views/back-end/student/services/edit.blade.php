                                            ...
                                            <ul class="wt-attachfile dropzone-previews">
                                                @if (!empty($attachments))
                                                    ...
                                                    <li id="attachment-item-{{$key}}">
                                                        ...
                                                        <em>
                                                            @if (Storage::disk('local')->exists('uploads/services/'.$student->user_id.'/'.$attachment))
                                                                {{ trans('lang.file_size') }} {{{Helper::bytesToHuman(Storage::size('uploads/services/'.$student->user_id.'/'.$attachment))}}}
                                                            @endif
                                                            <a href="{{{route('getfile', ['type'=>'services','attachment'=>$attachment,'id'=>$student->user_id])}}}"><i class="lnr lnr-download"></i></a>
