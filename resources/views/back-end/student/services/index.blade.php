											...
											<td data-th="Action">
												<span class="bt-content">
													<div class="wt-actionbtn">
														...
														@if ($total_orders == 0)
															<delete :title="'{{trans("lang.ph_delete_confirm_title")}}'" :id="'{{ $service['id'] }}'" :message="'{{trans("lang.ph_badge_delete_message")}}'" :url="'{{url('student/dashboard/delete-service')}}'"></delete>
														@endif
													</div>
												</span>
											</td>
