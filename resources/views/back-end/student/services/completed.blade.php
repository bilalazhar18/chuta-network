								...
								<tbody>
									@foreach ($services as $service)
										@php 
											...
											$student = App\User::find($seller->user_id);
															...
															<div class="wt-title">
																<a href="{{{url('profile/'.$student->slug)}}}">
																	@if ($student->user_verified)
																		<i class="fa fa-check-circle"></i> {{{Helper::getUserName($student->id)}}}
																	@endif
																</a>
																<h3>{{{$student->profile->tagline}}}</h3>
															</div>
															</div>
														</div>
													</div>
											...
											<td data-th="Action">
												<span class="bt-content">
													<div class="wt-actionbtn">
														<a href="{{{url('student/service/'.$service->pivot_id.'/completed')}}}" class="wt-viewinfo wt-btnhistory">{{ trans('lang.show_history') }}</a>
													</div>
												</span>
											</td>
										</tr>
