                            ...
                            <div class="wt-jobdetailscontent">
                                <div class="wt-userlistinghold wt-featured wt-proposalitem">
                                    ...
                                    <figure class="wt-userlistingimg">
                                        <img src="{{{asset(Helper::getProfileImage($student->id))}}}" alt="image description">
                                    </figure>
                ...
                <form class="wt-formtheme wt-formfeedback" id="submit-review-form">
                    <fieldset>
                        ...
                        <div class="form-group wt-btnarea">
                           <a class="wt-btn" href="javascript:void(0);" v-on:click='submitFeedback({{$student->id}}, {{$id}})'>{{ trans('lang.btn_send_feedback') }}</a>
                        </div>
                    </fieldset>
                </form>
            </div>
