                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                @if (!empty($logo) || Schema::hasTable('site_managements'))
                                    <strong class="wt-logo"><a href="{{{ url('/') }}}"><img class="image-logo" src="{{{ asset($logo) }}}" alt="{{{ trans('Logo') }}}"></a></strong>
                                @endif
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="wt-rightarea">
                                ...
                                @guest
                                    <div class="wt-loginarea">
                                         <a href="javascript:void(0);" id="wt-loginbtn" class="wt-btn">{{{trans('lang.login') }}}</a>
                                        <div class="wt-loginoption">
                                ...
                                @endauth
                                @if (!empty(Route::getCurrentRoute()) && Route::getCurrentRoute()->uri() != '/' && Route::getCurrentRoute()->uri() != 'home' && Route::getCurrentRoute()->uri() != 'student/submit-bank-details' && Route::getCurrentRoute()->uri() != 'student/payout-settings')
                                    <div class="wt-respsonsive-search"><a href="javascript:;" class="wt-searchbtn"><i class="fa fa-search"></i></a></div>
                                @endif
                            </div>
                        </div>
