                                    ...
                                    @foreach ($jobs as $job)
                                        ...
                                        ?>
                                              ...
                                              @endif
                                                               ...
                                                               <li><span><i class="far fa-folder wt-viewjobfolder"></i>{{{$job->paytype}}}</span></li>
                                                              
                                                              <li><span><i class="far fa-clock wt-viewjobclock"></i>{{ucwords($job->worktype)}}</span></li>
                                        ...
                                        @else 
                                            ...
                                            <div class="wt-userlistinghold wt-userlistingholdvtwo {{$featured_class}}">
                                                ...
                                                <div class="wt-userlistingcontent">
                                                    <div class="wt-contenthead">
                                                        <div class="wt-title">
                                                           {{--  <a href="{{ url('profile/'.$job->employer->id) }}"><i class="fa fa-check-circle"></i> {{{ Helper::getUserName($job->employer->id) }}}</a> --}}
                                                           <a href="javascrip:void(0)"><i class="fa fa-check-circle"></i> {{{ Helper::getUserName($job->employer->id) }}}</a>
                                                            <h2><a href="{{url('job/'.$job->id)}}">{{{$job->title}}}</a></h2>
                                                        </div>
                                                        <div class="wt-description">
                                                    ...
                                                    <div class="wt-viewjobholder">
                                                        <ul>
                                                           ...
                                                           <li><span><i class="far fa-clock wt-viewjobclock"></i>{{ucwords($job->paytype)}}</span></li>
                                                            ...
                                                            <!--<li><span><i class="far fa-clock wt-viewjobclock"></i>{{$job->work_type}}</span></li>-->
                                                            ...
                                                            @endif
                                                            <li class="wt-btnarea"><a href="{{url('job/'.$job->id)}}" class="wt-btn">{{{ trans('lang.view_job') }}}</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
