...
@section('content')
                        ...
                        <div class="wt-jobalertsholder la-jobalerts-holder">
                            <ul class="wt-jobalerts">
                                ...
                                @if ($job->status != 'posted')
                                    <li class="alert alert-danger alert-dismissible fade show">
                                        <span>{{{ trans('lang.hired_student_note') }}}</span>
                                        <a href="javascript:void(0)" class="wt-alertbtn danger close" data-dismiss="alert" aria-label="Close">Got It</a>
                                        <a href="javascript:void(0)" class="close" data-dismiss="alert" aria-label="Close">
                                            <i class="fa fa-close"></i>
                                        </a>
                                ...
                                <!--        <span><em>{{trans('lang.info')}}: </em> {{{ trans('lang.skill_req_student_note') }}}</span>-->
 ...
 --}}
                                ...
                                <div class="form-group form-group-half">
                                    <input placeholder="Enter First name" name="first_name" type="text" class="form-control" value="{{Auth::user()->first_name}}">
                                </div>

                                <div class="form-group form-group-half">

                                    <input placeholder="Enter Last name" name="last_name" type="text" class="form-control" value="{{Auth::user()->last_name}}">
                                </div>

                                <div class="form-group mt-2">
                                    <input placeholder="Enter Student Email" name="email" type="text" class="form-control" value="{{Auth::user()->email}}">
                                </div>
                                    ...
                                    <div class="form-group mt-2">
                                    <input placeholder="University" name="university" type="text" value="{{$profile[0]->university}}" class="form-control">
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <option value="{{$degree->id}}" @if (!empty($degree->id)) selected='selected' @endif>{{$degree->title}}</option>
                                    ...
                                    <div class="form-group mt-2">
                                        <textarea class="form-control" name="description" placeholder="Cover Letter">
                                        </textarea>
                                    </div>
                                ...
                                <div class="wt-attachments wt-attachmentsvtwo wt-attachmentsholder lara-proposal-attachment">
                                    <div class="lara-attachment-files"><div class="wt-title"><h3>Upload Document</h3>
                                    </div>
                                    <div class="multile-file-attachments wt-haslayout">
                                    <div id="upload" class="vue-dropzone dropzone dz-clickable"><div class="dz-message">
                                        <input type="file" name="attachments" class="form-control" style="background: #00cc8d">
