                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                            <div class="wt-bannercontent">
                                <div class="wt-bannerhead">
                                    <div class="wt-title">
                                        <h1>
                                            <span>ssss{{{ Helper::getHomeBanner('title') }}}</span>
                ...
                <section class="wt-haslayout wt-main-section wt-bglight">
                    <div class="container">
                        <div class="row justify-content-md-center">
                            ...
                            <div class="wt-students-holder wt-students-home row">
                                @if (!empty($services) && $services->count() > 0)
                                    @foreach ($services as $service)
                                        ...
                                        <div class="col-12 col-sm-12 col-md-6 col-lg-4 float-left">
                                            <div class="wt-students-info {{$no_attachments}}">
                                                @if($service->seller->count() > 0)
                                                    @if (!empty($attachments))
                                                        @php $enable_slider = count($attachments) > 1 ? 'wt-studentslider owl-carousel' : ''; @endphp
                                                        <div class="wt-students {{{$enable_slider}}}">
