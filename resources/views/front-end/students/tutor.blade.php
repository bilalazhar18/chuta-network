                ...
                <div class="row">
                    <div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 float-left">
                            @if (file_exists(resource_path('views/extend/front-end/students/filters1.blade.php'))) 
                            @include('extend.front-end.students.filters2')
                            @else 
                            @include('front-end.students.filters2')
                            @endif
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-8 float-left">
                            <div class="wt-userlistingholder wt-userlisting wt-haslayout">
                                ...
                                @if (count($users)>0)
                                    @foreach ($users as $key => $student)
                                        @php
                                          ...
                                          $profil=DB::table('profiles')->select('description','cgpa','tagline')->where('user_id',$student->id)->first();  
                                            ...
                                            <div class="wt-userlistingcontent">
                                                <div class="wt-contenthead">
                                                    <div class="wt-title">
                                                        ...
                                                        @if (!empty($profil->tagline))
                                                            <h2><a href="{{{ url('profile/'.$student->slug) }}}">{{{ $profil->tagline }}}</a></h2>
                                                        @endif
                              ...
                              $res=DB::table('skill_user')
->select('skills.title')
->join('skills','skill_user.skill_id','=','skills.id')
->where('skill_user.user_id',$student->id)->where('skill_user.is_tutor','=',1)
->get();
