                              ...
                              <div class="wt-students-details">
                                 <div class="wt-students-content">
                                    <div class="dc-title">
                                       ...
                                       <span><strong>AUD $ {{{$resources->price}}}</strong> </span>
                                    </div>
                                 </div>
                                     <div class="wt-students-rating">
                                                                 ...
                                                                 <b-modal ref="myModalRefs-{{$resources->slug}}" hide-footer title="Resource Reviews">
                                    ...
                                    ->where('transactions.resource_slug',$resources->slug)
                                    ->where('transactions.comment','!=','')
                                    ->get();
                                    ...
                                    <div class="wt-usersingle wt-servicesingle-holder"> 
                                     <div class="text-center"><strong> Reviews Count : </strong>{{{Helper::ratingresource($resources->slug)->count() }}}
                                     </div>
