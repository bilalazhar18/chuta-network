     ...
     {{--    <div class="wt-widget wt-effectiveholder wt-startsearch">
        ...
        <div class="wt-widget wt-effectiveholder">
            ...
            <div class="wt-widgetcontent">
                <fieldset>
                    <div class="form-group">
                        <input type="text" class="form-control filter-courseres" placeholder="{{ trans('lang.courses') }}">
                        <a href="javascrip:void(0);" class="wt-searchgbtn"><i class="lnr lnr-magnifier"></i></a>
                    </div>
                </fieldset>
                <fieldset>
                    @if (!empty($skills))
                        <div class="wt-checkboxholder wt-verticalscrollbar showresource"  style="max-height: 150px;overflow: hidden;overflow-y: auto;">
