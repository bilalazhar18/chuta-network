...
class EmployerEmailMailable extends Mailable
{
    ...
    public function build()
    {
        ...
        elseif($this->type == 'employer_email_proposal_received1')
        {
            $email_message = $this->prepareEmployerEmailPropsalReceived1($this->email_params);
        }
    ...
    public function prepareEmployerEmailPropsalReceived($email_params)
    {
       ...
       // $proposal_amount = $amount;
        ...
        $email_content_default =    "Hello %employer_name%,
                                    ...
                                    <a href='%student_link%'>%student_name%</a> has sent a new proposal on the following project <a href='%project_link%'>%resource_title%</a>.
    ...
    public function prepareEmployerEmailProposalMessage($email_params)
    {
        ...
        $email_content_default =    "Hello <a href='%employer_link%'>%employer_name%</a>,
                                    ...
                                    The <a href='%student_link%'>%student_name%</a> submit the proposal message on this job <a href='%project_link%'>%resource_title%</a>.
