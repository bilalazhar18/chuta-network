        ...
        if (!empty($request)) {
            ...
            if (!empty($request['meta'])) {
                foreach ($request['meta'] as $key => $value) {
                    if (!empty($value)) {
                        if ($key == 'students' || $key == 'cat' || $key == 'services' || $key == 'articles') {
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                            <div class="wt-bannercontent">
                                ...
                                <search-form :widget_type="'home'" :placeholder="'{{ trans('lang.looking_for') }}'" :student_placeholder="'{{ trans('lang.search_filter_list.student') }}'" :employer_placeholder="'{{ trans('lang.search_filter_list.employers') }}'" :job_placeholder="'{{ trans('lang.search_filter_list.jobs') }}'" :service_placeholder="'{{ trans('lang.search_filter_list.services') }}'" :no_record_message="'{{ trans('lang.no_record') }}'">
                                </search-form>
                            </div>
                        </div>
                    </div>
