...
class Skill extends Model
{
    ...
    /**
     * The student that belong to the skill.
     *
     * @return relation
     */
     ...
     * @return \Illuminate\Http\Response
     */
    public static function getstudentSkill($user_id)
    {
    ...
    public static function getstudentSkills($user_id)
    {
        return DB::table('skill_user')->where('user_id', $user_id)
            ->get()->toArray();
    }
