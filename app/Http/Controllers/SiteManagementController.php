...
class SiteManagementController extends Controller
{
    ...
    public function homePageSettings()
    {
        ...
        $banner_title = !empty($home_settings[0]['banner_title']) ? $home_settings[0]['banner_title'] : 'Hire expert students';
        ...
        $student_title = !empty($section_settings[0]['student_title']) ? $section_settings[0]['student_title'] : null;
        $student_desc = !empty($section_settings[0]['student_desc']) ? $section_settings[0]['student_desc'] : null;
        $student_url = !empty($section_settings[0]['student_url']) ? $section_settings[0]['student_url'] : null;
        ...
        if (file_exists(resource_path('views/extend/back-end/admin/home-page-settings/index.blade.php'))) {
            return view(
                ...
                compact(
                    ...
                    'company_url', 'student_title', 'student_desc',
                    'student_url', 'section_bg', 'download_app_img',
