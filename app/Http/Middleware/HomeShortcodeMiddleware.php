                ...
                <div class="form-group">
                    ...
                    <div class="wt-formoptions">
                        <div class="wt-dropdown">
                            <span>In: <em class="selected-search-type">students </em><i class="lnr lnr-chevron-down"></i></span>
                        </div>
                        <div class="wt-radioholder">
                            <span class="wt-radio">
                                <input id="wt-students" data-title="students" type="radio" name="searchtype" value="student" checked="">
                                <label for="wt-students">students</label>
                            </span>
                            <span class="wt-radio">
