    ...
    public static function saveSectionSettings($section_settings, $request)
    {
        if (!empty($section_settings) || !empty($request)) {
            ...
            foreach ($section_settings as $key => $section) {
                ...
                $section_settings[$key]['student_title'] = $section['student_title'];
                $section_settings[$key]['student_desc'] = $section['student_desc'];
                $section_settings[$key]['student_url'] = $section['student_url'];
