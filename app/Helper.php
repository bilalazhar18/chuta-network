...
class Helper extends Model
{
    ...
    {
        $list = array(
                '1' => trans('lang.subjects_list.focp'),
                '2' => trans('lang.subjects_list.oop'),
                '3' => trans('lang.subjects_list.dsa'),
                '4' => trans('lang.subjects_list.dbs'),
                '5' => trans('lang.subjects_list.coal'),
                '6' => trans('lang.subjects_list.web'),
        );
        return $list;
    }
    ...
    {
        $list = array(
                '1' => trans('lang.genders_list.male'),
                '2' => trans('lang.genders_list.female'),
                '3' => trans('lang.genders_list.other'),
        );
        return $list;
    }
    ...
    {
        $list = array(
                '1' => trans('lang.faculty_list.analytics'),
                '2' => trans('lang.faculty_list.bus'),
                '3' => trans('lang.faculty_list.comm'),
                '4' => trans('lang.faculty_list.creative'),
                '5' => trans('lang.faculty_list.design'),
                '6' => trans('lang.faculty_list.edu'),
                '7' => trans('lang.faculty_list.engineering'),
                '8' => trans('lang.faculty_list.health'),
                '9' => trans('lang.faculty_list.infotech'),
                '10' => trans('lang.faculty_list.internalstudies'),
                '11' => trans('lang.faculty_list.law'),
                '12' => trans('lang.faculty_list.science'),
                '13' => trans('lang.faculty_list.transino'),
        );
        return $list;
    }
    ...
    {
        if (empty($image) && isset($_GET['type']) && $_GET['type'] == 'student') {
    ...
    public static function getPageSections($key = "")
    {
        $list = array(
            ...
            '7' => array(
                'name' => trans('lang.student_section'),
    ...
    public static function getWorkTypeList($key = "")
    {
        $list = array(
            'fulltime' => trans('lang.worktype.fulltime'),
            'parttime' => trans('lang.worktype.parttime'),
            'casual' => trans('lang.worktype.casual'),
            'intern' => trans('lang.worktype.intern'),
            'cadet' => trans('lang.worktype.cadet'),
            'scholarship' => trans('lang.worktype.scholarship'),
        );
        if (!empty($key) && array_key_exists($key, $list)) {
            return $list[$key];
        } else {
    ...
    public static function getPayTypeList($key = "")
    {
        $list = array(
            'hourly' => trans('lang.paytype.hourly'),
            'salary' => trans('lang.paytype.salary'),
        );
        if (!empty($key) && array_key_exists($key, $list)) {
            return $list[$key];
        } else {
    ...
    {
        $list = array(
            'accounting' => trans('lang.category.accounting'),
            'engineering' => trans('lang.category.engineering'),
            'marketing' => trans('lang.category.marketing'),
            'developer' => trans('lang.category.developer'),
        );
        if (!empty($key) && array_key_exists($key, $list)) {
            return $list[$key];
        } else {
    ...
    {
        $list = array(
            '0-5' => trans('lang.student_hourly_rate.0_5'),
            '5-10' => trans('lang.student_hourly_rate.5_10'),
            '10-20' => trans('lang.student_hourly_rate.10_20'),
            '20-30' => trans('lang.student_hourly_rate.20_30'),
            '30-40' => trans('lang.student_hourly_rate.30_40'),
            '40-50' => trans('lang.student_hourly_rate.40_50'),
            '50-60' => trans('lang.student_hourly_rate.50_60'),
            '60-70' => trans('lang.student_hourly_rate.60_70'),
            '70-80' => trans('lang.student_hourly_rate.70_80'),
            '90-0' => trans('lang.student_hourly_rate.90_0'),
        );
        if (!empty($key) && array_key_exists($key, $list)) {
            return $list[$key];
        } else {
     ...
     * @return array
     */
    public static function getstudentLevelList($key = "")
    {
        $list = array(
            'independent'       => trans('lang.student_level.independent'),
            'agency'            => trans('lang.student_level.agency'),
            'rising_talent'     => trans('lang.student_level.rising_talent'),
        );
        if (!empty($key) && array_key_exists($key, $list)) {
            return $list[$key];
        } else {
    ...
    public static function getPackageDurationList($key = "")
    {
        $list = array(
            ...
            '60' => trans('lang.pckge_duration.60'),
            '90' => trans('lang.pckge_duration.90'),
        );
        if (!empty($key) && array_key_exists($key, $list)) {
            return $list[$key];
        } else {
     ...
     * @return array
     */
    public static function getstudentBadgeList($key = "")
    {
        $list = array(
    ...
    public static function getUserName($user_id)
    {
     ...
     public static function getFacultyName($name)
    {
        if (!empty($name)) {
            
            return Faculty::find($name)->title;
        } else {
            return '';
        }
    }
            ...
            if ($role == 'employer') {
                $list = array(
                    ...
                    // '5' => trans('lang.emp_pkg_opt.pvt_cht'),
                     ...
                     '0' => trans('lang.emp_pkg_opt.price'),
                     '1' => trans('lang.emp_pkg_opt.email'),
                     '2' => trans('lang.emp_pkg_opt.target'),
                     '3' => trans('lang.emp_pkg_opt.profile'),
                ...
                $list = array(
                    '0' => trans('lang.student_pkg_opt.price'),
                    '1' => trans('lang.student_pkg_opt.no_of_credits'),
                    '2' => trans('lang.student_pkg_opt.no_of_skills'),
                    '3' => trans('lang.student_pkg_opt.no_of_services'),
                    '4' => trans('lang.student_pkg_opt.no_of_featured_services'),
                    '5' => trans('lang.student_pkg_opt.pkg_duration'),
                    '6' => trans('lang.student_pkg_opt.badge'),
                    '7' => trans('lang.student_pkg_opt.banner'),
                    '8' => trans('lang.student_pkg_opt.pvt_cht'),
                );
            }
            return $list;
        }
   ...
   public static function getSearchFilterList($key = "")
    {
        $list = array(
            '0' => array(
                'title' => trans('lang.search_filter_list.student'),
                'value' => 'student',
            ),
            '1' => array(
            ...
            '2' => array(
                'title' => trans('lang.search_filter_list.resources'),
            ),
            '3' => array(
                'title' => trans('lang.search_filter_list.tutor'),
            ),
        );
    ...
    public static function getSearchableList($type)
    {
        ...
        Log::info("I am search Type.");
        Log::info($type);
        $json = array();
        if ($type == 'student') {
            $stud = User::role('student')->select(
                DB::raw("CONCAT(users.first_name,' ',users.last_name) AS name,slug"),
                DB::raw("'student' AS type")
            )->where('is_disabled', 'false')->get()->toArray();


             $email= User::role('student')->select('email as name', 'slug', DB::raw("'student' AS type")
            )->where('is_disabled', 'false')->get()->toArray();
            ...
            $degree= DB::table("degrees")
                ->select(
                    "title AS name",
                    "id as slug",
                    DB::raw("'degree' AS type")
                )->get()->toArray();

            $skilks= DB::table("skills")
                ->select(
                    "title AS name",
                    "id as slug",
                    DB::raw("'skills' AS type")
                )->get()->toArray();

        // $cgpa=DB::table('users')
        // ->select('profiles.cgpa as name','users.first_name', DB::raw("'cgpa' AS type"))
        // ->join('profiles','profiles.user_id','=','users.id')
        // ->where('profiles.cgpa','>=',1)
        // ->get()->toArray();

        $cgpa=DB::table('profiles')
        ->select('cgpa as name','cgpa as slug', DB::raw("'cgpa' AS type"))
        ->where('cgpa','>=',1)
        ->get()->toArray();



        $freelancs=array_merge($stud,$email,$location,$degree,$skilks,$cgpa);
            $json = $freelancs;
...
//           {
//             $student = User::role('student')->select(
//                 DB::raw("CONCAT(users.first_name,' ',users.last_name) AS name,slug"),
//                 DB::raw("'tutor' AS type")
//             )->where('is_disabled', 'false')->where('id',$val->user_id)->get()->toArray();
//           }
...
//         $tutorgets = DB::table("skill_user")
//         ->select(
//         "is_tutor",
//         'user_id'
//         )->groupby('user_id')->where('is_tutor','=',1)->get();
//         foreach($tutorgets as $val)
//         {      
//         $email= User::role('student')->select('email as name', 'slug', DB::raw("'tutor' AS type")
//                 )->where('is_disabled', 'false')->where('id',$val->user_id)->get()->toArray();
...
// //        $email = User::role('student')->select('email as name','id as slug')->where('is_disabled', 'false')->where('is_tutor',1)->get()->toArray();
//         $tutor=array_merge($student,$email,$location,$degree,$skills);
//         $json = $tutor;
...
//         }
        ...
        if ($type == 'job') {
         ...
         $jobs=array_merge($job,$location,$fac);
         $json = $jobs;
            
        }
        // if ($type == 'resource') {
        //     $services = DB::table("resources")
        //         ->select(
        //             "title AS name",
        //             "slug as slug",
        ...
        //     $resourceall=array_merge($services,$course);
    ...
    {
        $profile_image = 'listing-'.User::find($user_id)->profile->avater;
    ...
    public static function getProposals($user_id, $status)
    {
     ...
     public static function getsresource($user_id)
    {

          return DB::table('resources')->where('user_id', $user_id)->get();
    }

    public static function getsresourceprice($user_id)
    {

          return DB::table('transactions')->where('seller_id',$user_id)->sum('total_price');
    }

     public static function numconnection($user_id)
    {
        return DB::table('offers')->where('user_id', $user_id)->sum('is_friend');

    }

     public static function soldresource($user_id)
    {
       return DB::table('transactions')->where('seller_id',$user_id)->get();

    }


    public static function ratingresource($user_id)
    {
       return DB::table('transactions')->where('resource_slug',$user_id)->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public static function getstudentJobTotalEarning($user_id, $status, $paid_status = 'pending')
    {
        $commision = SiteManagement::getMetaValue('commision');
        $admin_commission = !empty($commision) && !empty($commision[0]['commision']) ? $commision[0]['commision'] : 0;
        $job_balance =  Proposal::select('amount')
    ...
    public static function getHomeBanner($type, $size = '')
    {
        ...
        $banner_title  = 'Connect with expert students, employers, and access certified student resources. ';
    ...
    public static function getHomeSection($type)
    {
        ...
        $student_title = !empty($section_settings) && !empty($section_settings[0]['student_title']) ? $section_settings[0]['student_title'] : null;
        $student_desc = !empty($section_settings) && !empty($section_settings[0]['student_desc']) ? $section_settings[0]['student_desc'] : null;
        $student_url = !empty($section_settings) && !empty($section_settings[0]['student_url']) ? $section_settings[0]['student_url'] : '#';
    ...
    public static function getIconList($icon = "")
    {
        $icons = array(
            ...
            'liked_student' => array(
                'value' => 'liked_student',
                'title' => trans('lang.liked_students'),
            ),
            'cancel_job' => array(
                'value' => 'cancel_job',
     ...
     * @return array
     */
    public static function getstudentServiceStatus($status = '')
    {
        $status_list = array(
            'published' => array(
     ...
     * @return array
     */
    public static function getstudentServices($status, $user_id, $paid_status = '')
    {
     ...
     * @return array
     */
    public static function getTotalstudentServices($status, $user_id)
    {
        return DB::table('services')
            ->join('service_user', 'service_user.service_id', '=', 'services.id')
            ->select('services.*', 'service_user.id as pivot_id', 'service_user.user_id as pivot_user', 'service_user.type', 'service_user.status as pivot_status')
     ...
     * Get service reviews
     *
     * @param int $receiver_id student id
     ...
     * @return array
     */
    public static function getstudentNewOrderEmailContent()
    {
        $output = "";
        $output .= "Hello %student_name%";
     ...
     * @return array
     */
    public static function getstudentCompletedServiceEmailContent()
    {
        $output = "";
        $output .= "Hello %student_name%";
        $output .= "The <a href='%employer_link%'>%employer_name%</a> has confirmed that the following project (%resource_title%) is completed.";
     ...
     * @return array
     */
    public static function getstudentCancelledServiceEmailContent()
    {
        $output = "";
        $output .= "Hello <a href='%student_link%'>%student_name%</a>,";
        $output .= "Unfortunately <a href=' %employer_link%'>%employer_name%</a> cancelled the <a href='%project_link%'>%resource_title%</a> service due to following below reasons.";
        $output .= "%message%";
        $output .= "%signature%";
        return $output;
    }
    ...
    public static function getAdminServicePostedEmailContent()
    {
        $output = "";
        $output .= "Hello";
        $output .= "A new service is posted by <a href='%student_link%'>%student_name%</a>.";
    ...
    public static function getFirstHomeSlider()
    {
        ...
        $data['title'] = 'Hire expert students';
     ...
     * @return \Illuminate\Http\Response
     */
    public static function getSecondHomestudent()
    {
        $data = array();
        $data['title'] = 'Top students';
     ...
     * @return \Illuminate\Http\Response
     */
    public static function getThirdHomestudent()
    {
        $data = array();
        $data['title'] = 'Top students';
        $data['subtitle'] = 'Start With Great Peoples';
